...
def infoParameters(identity, dateFieldValue=None):
    ...
    return ParametersApplication(tecnologyDatastoreSource, tecnologyDatastoreDestiny, structureFieldsDataframeSource, dateField, dateFieldValueDefault, dateFieldValue, dateFieldFormat,
